...
def repair_basic_tables():
    ...
    with db.engine.begin() as conn:
        ...
        for col, typ in [
            ("name","VARCHAR(120)"),("storage_limit_gb","INTEGER DEFAULT 512"),
            ("monthly_price","NUMERIC(10,2) DEFAULT 0"),("commission_rate","INTEGER DEFAULT 20"),
        ...
        for col, typ in [
            ...
            ("commission_override_reason","VARCHAR(500)"),
            ("product_commission_rate","INTEGER DEFAULT 20"),("product_commission_override_rate","INTEGER"),
            ("product_commission_override_until","TIMESTAMP"),("product_commission_override_reason","VARCHAR(500)"),
            ("second_clip_discount_percent","INTEGER DEFAULT 0"),("approved","BOOLEAN DEFAULT FALSE"),
            ("suspended","BOOLEAN DEFAULT FALSE"),("created_at","TIMESTAMP DEFAULT CURRENT_TIMESTAMP")
        ]:
